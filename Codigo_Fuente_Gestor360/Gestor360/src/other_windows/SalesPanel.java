...
public class SalesPanel extends JPanel {
    ...
    private void addCenterPanel() {
        ...
        btnIrCompras.setBorderPainted(false);
        btnIrCompras.setContentAreaFilled(true);
        ...
        btnIrCompras.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                btnIrCompras.setBackground(new Color(0, 70, 120));
            }
