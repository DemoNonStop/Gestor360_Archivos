    ...
    private void addMainPanel() {
        ...
        btnEnviar.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                btnEnviar.setBackground(new Color(0, 106, 212));
            }
        ...
        btnLimpiar.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                btnLimpiar.setBackground(new Color(90, 90, 90));
            }
        ...
        btnAdjuntar.setContentAreaFilled(true);
        ...
        btnAdjuntar.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                btnAdjuntar.setBackground(new Color(0, 106, 212));
            }
